...
public class MyEducationAdapterTwo extends DefualtAdapter {
    ...
    public MyEducationAdapterTwo(List<String> datas, String company_name) {
        super(datas);
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      //  Log.i("company_namecompany_name",company_name);

      //  if (company_name!=null){
            if (company_name.equals(datas.get(position))){
              //  Log.i("company_name3333",company_name);
