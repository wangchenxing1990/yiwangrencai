...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    private void updateTitleSelect(int index) {
        ...
        if (photo.isChoose()) {
            previewSelectBtn.setImageResource(R.mipmap.selected);
        } else {
            previewSelectBtn.setImageResource(R.mipmap.picker_preview_unselected);
        }
    }
    ...
    private void updatePreviewSelectBtnStatus(boolean isChoose) {
        if (isChoose) {
            previewSelectBtn.setImageResource(R.mipmap.picker_image_selected);
        } else {
            previewSelectBtn.setImageResource(R.mipmap.picker_preview_unselected);
        }
    }
    ...
    private void updateOriImageSizeTip(boolean isOri) {
        ...
        if (isOri) {
            ...
            originalImage.setImageResource(R.mipmap.picker_orignal_checked);
        } else {
            originalImageSizeTip.setText(R.string.picker_image_preview_original);
            originalImage.setImageResource(R.mipmap.picker_orignal_normal);
        }
    }
