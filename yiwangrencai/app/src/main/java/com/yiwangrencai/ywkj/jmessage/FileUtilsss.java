...
public class FileUtilsss {
    ...
    public static String getCacheDirPath(Context context) {
        if (isSDCardExist()) {
            ...
            File directory = new File(context.getCacheDir(), FileUtilsss.FILE_DIR);
            if (!directory.exists()) directory.mkdirs();
    ...
    public static String getUploadCachePath(Context context) {
        if (isSDCardExist()) {
            ...
            File directory = new File(context.getCacheDir(), FileUtilsss.FILE_DIR + File.separator + UPLOAD_FILE);
            if (!directory.exists()) directory.mkdirs();
            return directory.getAbsolutePath();
        }
    }
