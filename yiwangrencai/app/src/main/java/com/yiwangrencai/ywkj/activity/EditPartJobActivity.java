...
import com.yiwangrencai.ywkj.bean.PartTimeBean.DataBean;
...
public class EditPartJobActivity extends BaseActiviyt {
    ...
    private void gainDataFromService() {
        ...
        Request request = new Request.Builder()
                .url(ContentUrl.BASE_URL + ContentUrl.PART_RESUME_EDIT)
    ...
    private void saveSendDataToservice() {
        ...
        Request request=new Request.Builder()
                .url(ContentUrl.BASE_URL+ContentUrl.PART_RESUME_UPDATE)
                .addHeader(ContentUrl.ACCEPT,ContentUrl.APPJSON)
                .addHeader(ContentUrl.AUTHORIZATION,ContentUrl.BEAR+api_token)
                .post(form.build())
                .build();
