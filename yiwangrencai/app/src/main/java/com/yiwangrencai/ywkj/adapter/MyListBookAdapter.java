...
public class MyListBookAdapter extends DefualtAdapter {
    ...
    public MyListBookAdapter(List<BookBean> datas) {
        super(datas);
        this.datas=datas;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textworkname.setText(datas.get(position).getCertificate_name());
        holder.textcompanyname.setText(datas.get(position).getGettime_name());
